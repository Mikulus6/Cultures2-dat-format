...
section_names = ("logi", "lgmm", "lsiz", "lmhe", "lmpa", "lmpb", "lmlt", "lmlv", "lmlp", "lmco", "lmtw", "lmms", "lmpr",
...
section_matrices = {"lmhe": (1, 1), "lmpa": (1, 1), "lmpb": (1, 1), "lmlt": (1, 2), "lmlv": (1, 2), "lmlp": (1, 2),
...
derivations_dependencies = {"lsiz": ("empa",),
                            "lmpa": ("lsiz", "eapd", "empa"),
                            "lmpb": ("lsiz", "eapd", "empb"),
                            "lmlt": ("lsiz", "emla", "eald"),
                            "lmco": ("lsiz", "lmpa", "lmpb"),
