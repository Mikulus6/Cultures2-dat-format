...
patterns_entries_keys_duplicaded    = ()
...
patterns    = ExternalAssets(patterns_path,    section_name="GfxPattern",   key_name="EditName", entries_duplicated=patterns_entries_keys_duplicaded)
